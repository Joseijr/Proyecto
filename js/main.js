const app = Vue.createApp({
    ...
    methods: {
        ...
        cargarPartida() {
            fetch("http://backend.test/api/v1/game/data", {
                method: "GET",
                headers: {
        ...
        async buySeed(id) {
            ...
            try {
                const res = await fetch(`http://backend.test/api/plants/${id}/${price}/sumar`, {
                    method: "PUT",
                    headers: {
        ...
        async useSeed(id) {
            ...
            try {
                const res = await fetch(`http://backend.test/api/plants/${id}/restar`, {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer " + localStorage.getItem("token")
        ...
        async buyPlot(side, index) {
            ...
            try {
                const res = await fetch("http://backend.test/api/plots/buy", {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer " + localStorage.getItem("token")
